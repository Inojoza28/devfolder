  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "CodePast — Snippet manager for developers" },
      {
        ...
        content:
          "Minimal, local-first snippet manager. Save, organize and search your code.",
      },
    ...
    links: [
      ...
      { rel: "icon", type: "image/png", sizes: "32x32", href: logoSrc },
      { rel: "apple-touch-icon", sizes: "180x180", href: logoSrc },
    ],
  }),
